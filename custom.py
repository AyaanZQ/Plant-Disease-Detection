...
ROOT_DIR = "C:/Users/Ayaan/Desktop/Plant Detection"
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 16, "Potato_Early_Blight")
        ...
        self.add_class("object", 21, "Strawberry_Leaf_Scorch")
...
def train(model):
    ...
    dataset_train.load_custom("C:/Users/Ayaan/Desktop/Plant Detection/dataset", "train")
    
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("C:/Users/Ayaan/Desktop/Plant Detection/dataset", "val")
    dataset_val.prepare()
